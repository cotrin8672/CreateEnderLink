...
object LinkCountManager {
    ...
    fun registerEntity(key: ResourceKey<out Block>?, entity: SmartBlockEntity) {
        key?.let {
    ...
    fun unregisterEntity(key: ResourceKey<out Block>?, entity: SmartBlockEntity) {
    ...
    fun getLoadingBlockEntities(key: ResourceKey<out Block>): List<SmartBlockEntity> {
